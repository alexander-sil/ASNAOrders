...
namespace ASNAOrders.Web.Administration.Client.OpenApi.Model
{
    ...
    public partial class Config : IEquatable<Config>, IValidatableObject
    {
        ...
        public Config(string mqvHost = default, string mqHostname = default, int? mqPort = default, bool? issuerSigningKeySetToAuto = default, string issuerSigningKey = default, bool? signingKeyFileSetToAuto = default, string clientId = default, bool? clientIdSetToAuto = default, string signingKeyFile = default, bool? clientSecretSetToAuto = default, string clientSecret = default, bool? clientSecretFilenameSetToAuto = default, string clientSecretFilename = default, string databaseType = default, string xmlStockPath = default, string sqliteDbCacheFilename = default, string mssqlServerHost = default, int? mssqlServerPort = default, string mssqlServerUsername = default, string mssqlServerPassword = default, string connectionString = default, string initialCatalog = default, string sink = default, string errorLogPrefix = default, string mailPassword = default, string mailTo = default, string mailHost = default, int? mailPort = default, string mailSSLOptions = default, string clientSecretTransmissionMethod = default)
        {
            MqvHost = mqvHost;
