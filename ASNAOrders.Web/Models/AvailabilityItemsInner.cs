...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AvailabilityItemsInner : IEquatable<AvailabilityItemsInner>
    {
        /// <summary>
        ...
        /// <summary>
        /// Актуальный остаток товара в магазине. Для штучных товаров передается значение в штуках: 1, 2, 5. Для весовых товаров передается значение в килограммах: 0.8, 3.49, 17.25
        /// </summary>
        /// <value>Актуальный остаток товара в магазине. Для штучных товаров передается значение в штуках: 1, 2, 5. Для весовых товаров передается значение в килограммах: 0.8, 3.49, 17.25</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AvailabilityItemsInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AvailabilityItemsInner)obj);
        }

        /// <summary>
        /// Returns true if AvailabilityItemsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of AvailabilityItemsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AvailabilityItemsInner other)
        {
        ...
        public static bool operator ==(AvailabilityItemsInner left, AvailabilityItemsInner right)
        {
