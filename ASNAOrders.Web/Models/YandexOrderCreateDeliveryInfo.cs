...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class YandexOrderCreateDeliveryInfo : IEquatable<YandexOrderCreateDeliveryInfo>
    {
        /// <summary>
        ...
        [Required]
        [DataMember(Name="courierArrivementDate", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class YandexOrderCreateDeliveryInfo {\n");
            sb.Append("  ClientName: ").Append(ClientName).Append("\n");
            sb.Append("  PhoneNumber: ").Append(PhoneNumber).Append("\n");
            sb.Append("  CourierArrivementDate: ").Append(CourierArrivementDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((YandexOrderCreateDeliveryInfo)obj);
        }

        /// <summary>
        /// Returns true if YandexOrderCreateDeliveryInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of YandexOrderCreateDeliveryInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(YandexOrderCreateDeliveryInfo other)
        {
            ...
            return 
                ...
                (
                    CourierArrivementDate == other.CourierArrivementDate ||
                    CourierArrivementDate != null &&
                    CourierArrivementDate.Equals(other.CourierArrivementDate)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (CourierArrivementDate != null)
                    hashCode = hashCode * 59 + CourierArrivementDate.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(YandexOrderCreateDeliveryInfo left, YandexOrderCreateDeliveryInfo right)
        {
