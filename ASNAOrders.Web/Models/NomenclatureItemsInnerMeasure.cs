...
{ 
    /// <summary>
    /// Измерительная характеристика товара, например, вес или объем
    /// </summary>
    [DataContract]
    public partial class NomenclatureItemsInnerMeasure : IEquatable<NomenclatureItemsInnerMeasure>
    {
        /// <summary>
        ...
        /// <example>0.3</example>
        [DataMember(Name="quantum", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NomenclatureItemsInnerMeasure {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((NomenclatureItemsInnerMeasure)obj);
        }

        /// <summary>
        /// Returns true if NomenclatureItemsInnerMeasure instances are equal
        /// </summary>
        /// <param name="other">Instance of NomenclatureItemsInnerMeasure to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NomenclatureItemsInnerMeasure other)
        {
        ...
        public static bool operator ==(NomenclatureItemsInnerMeasure left, NomenclatureItemsInnerMeasure right)
        {
