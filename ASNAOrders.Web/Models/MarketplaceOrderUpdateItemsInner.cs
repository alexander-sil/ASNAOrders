...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class MarketplaceOrderUpdateItemsInner : IEquatable<MarketplaceOrderUpdateItemsInner>
    {
        /// <summary>
        ...
        /// <summary>
        /// Количество товара в заказе. Для весовых товаров количество передается в кг (3.4).
        /// </summary>
        /// <value>Количество товара в заказе. Для весовых товаров количество передается в кг (3.4).</value>
        /// <example>3</example>
        [Required]
        ...
        /// <summary>
        /// Объект с информацией о маркировке товара
        /// </summary>
        /// <value>Объект с информацией о маркировке товара</value>
        [DataMember(Name="marking", EmitDefaultValue=false)]
        public List<YandexOrderUpdateItemsInnerMarkingInner> Marking { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarketplaceOrderUpdateItemsInner {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MarketplaceOrderUpdateItemsInner)obj);
        }

        /// <summary>
        /// Returns true if MarketplaceOrderUpdateItemsInner instances are equal
        /// </summary>
        /// <param name="other">Instance of MarketplaceOrderUpdateItemsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketplaceOrderUpdateItemsInner other)
        {
            ...
            return 
                ...
                (
                    ...
                    Marking != null &&
                    other.Marking != null &&
                    Marking.SequenceEqual(other.Marking)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Marking != null)
                    hashCode = hashCode * 59 + Marking.GetHashCode();
        ...
        public static bool operator ==(MarketplaceOrderUpdateItemsInner left, MarketplaceOrderUpdateItemsInner right)
        {
