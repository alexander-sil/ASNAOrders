...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class MarketplaceOrderCreateDeliveryInfo : IEquatable<MarketplaceOrderCreateDeliveryInfo>
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="deliverySlot", EmitDefaultValue=false)]
        public MarketplaceOrderCreateDeliveryInfoDeliverySlot DeliverySlot { get; set; }
        ...
        public MarketplaceOrderCreateDeliveryInfoDeliveryAddress DeliveryAddress { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarketplaceOrderCreateDeliveryInfo {\n");
            sb.Append("  ClientName: ").Append(ClientName).Append("\n");
            sb.Append("  PhoneNumber: ").Append(PhoneNumber).Append("\n");
            sb.Append("  DeliveryDate: ").Append(DeliveryDate).Append("\n");
            sb.Append("  DeliverySlot: ").Append(DeliverySlot).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MarketplaceOrderCreateDeliveryInfo)obj);
        }

        /// <summary>
        /// Returns true if MarketplaceOrderCreateDeliveryInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of MarketplaceOrderCreateDeliveryInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MarketplaceOrderCreateDeliveryInfo other)
        {
            ...
            return 
                ...
                (
                    ...
                    DeliverySlot != null &&
                    DeliverySlot.Equals(other.DeliverySlot)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + DeliverySlot.GetHashCode();
        ...
        public static bool operator ==(MarketplaceOrderCreateDeliveryInfo left, MarketplaceOrderCreateDeliveryInfo right)
        {
