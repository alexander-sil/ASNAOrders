...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class YandexOrderCreatePaymentInfo : IEquatable<YandexOrderCreatePaymentInfo>
    {
        /// <summary>
        /// Полная стоимость товаров в заказе
        /// </summary>
        /// <value>Полная стоимость товаров в заказе</value>
        ...
        /// </summary>
        /// <value>Информация о типе оплаты. CARD - это оплаченный заказ клиентом на стороне Яндекс Еды, CASH - это неоплаченный заказ (используется в основном при самовывозе алкоголя).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class YandexOrderCreatePaymentInfo {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((YandexOrderCreatePaymentInfo)obj);
        }

        /// <summary>
        /// Returns true if YandexOrderCreatePaymentInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of YandexOrderCreatePaymentInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(YandexOrderCreatePaymentInfo other)
        {
        ...
        public static bool operator ==(YandexOrderCreatePaymentInfo left, YandexOrderCreatePaymentInfo right)
        {
